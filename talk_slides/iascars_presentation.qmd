...
When it comes to understanding <span class = "accent-color"> a model's decision process for a specific instance </span>, there are several key methods that are related to each other in how they approach the problem
...
<p style="text-align:center"><img src="imgs/n_dim_state_plot_2.gif" style="width:90%"/></p>

<p class = "text-align:center"> <h4> Instance 1 (blue) </h4> </p>

:::

::: {.column width=50%}

<p style="text-align:center"><img src="imgs/n_dim_state_plot_2_2.gif" style="width:90%"/></p>

<p class = "text-align:center"> <h4> Instance 2 (red) </h4> </p>
...
* From the two possible methods, <span class = "accent-color">local interpretability methods </span> (which explains the decision process of one instance) are more useful in this setting
...
<p style="line-height:0.8;"><span style = "font-size: 1.5rem"> A majority of the points in the box are lightning predictions</span> </p>
...
<p style="line-height:0.8;"><span style = "font-size: 1.5rem">There are clear clusters in the bivariate relationships indicating that there are relationships between the variables that would be heavily influential in building a model boundary.</span></p>
